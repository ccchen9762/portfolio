...
const int marchSteps = 60;
const int oceanOctaves = 3;
...
void main(){
    ...
    if(totalDistance > maxDistance){ 
        ...
        float twinkleSpeed = 7.0 + hash11(dot(gridPos, vec2(123.4, 567.8))) * 3.0;
        float twinkle = 0.8 + 0.1 * sin(uTime * twinkleSpeed);
